...
export function getAnnate(args = {}) {
...
export function dismissGetAnnateError() {
  return {
...
export function reducer(state, action) {
  switch (action.type) {
    case HOME_GET_ANNATE_BEGIN:
      // Just after a request is sent
      return {
        ...state,
        getAnnatePending: true,
        getAnnateError: null,
      };

    case HOME_GET_ANNATE_SUCCESS:
      // The request is success
      return {
        ...state,
        getAnnatePending: false,
        getAnnateError: null,
        annateList: action.data,
      };

    case HOME_GET_ANNATE_FAILURE:
      // The request is failed
      return {
        ...state,
        getAnnatePending: false,
        getAnnateError: action.data.error,
      };

    case HOME_GET_ANNATE_DISMISS_ERROR:
